...
public class SysYParser extends Parser {
	...
	public static final int
		...
		DIGIT=44, OCTAL_DIGIT=45, HEX_DIGIT=46, FLOAT_CONST=47, DECIMAL_FLOAT_CONST=48, 
		HEX_FLOAT_CONST=49, FRACTIONAL_CONST=50, EXPONENT_PART=51, SIGN=52, DIGIT_SEQUENCE=53, 
		HEX_FRACTIONAL_CONST=54, BINARY_EXPONENT_PART=55, HEX_DIGIT_SEQUENCE=56, 
		FLOAT_SUFFIX=57;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"HEX_DIGIT", "FLOAT_CONST", "DECIMAL_FLOAT_CONST", "HEX_FLOAT_CONST", 
			"FRACTIONAL_CONST", "EXPONENT_PART", "SIGN", "DIGIT_SEQUENCE", "HEX_FRACTIONAL_CONST", 
			"BINARY_EXPONENT_PART", "HEX_DIGIT_SEQUENCE", "FLOAT_SUFFIX"
		};
	}
